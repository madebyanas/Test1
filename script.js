...
async function handleFormSubmit(e) {
    ...
    // Afficher la popup après un court délai, que l'envoi ait réussi ou non
    setTimeout(() => {
...
async function sendDataToGoogleSheets(name, phone, scores) {
    ...
    // 🟢 METS TON URL ICI ⬇️
    const scriptURL = 'https://script.google.com/macros/s/AKfycbynJarS85PnZrq13ip4jeakgYlLNK7W8xsxpe7N4rU9IdLix7KLC_sfzWfuSXGX3ZLUkQ/exec';
